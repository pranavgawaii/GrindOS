...
# CONSTRUCT 80 CONTENT PAGES (1 page per topic)
for t in topics_data:
    page_html = f"""
<div class="page" id="{t['id']}">
  <div class="header">
    <div class="header-left">
      <img class="header-logo" src="data:image/png;base64,{LOGO_BASE64}" alt="GrindOS Logo">
      <div class="header-wordmark">GrindOS</div>
  ...
  <div class="body-container-sysdesign">
    ...
    <div class="sysdesign-bottom-placement-grid">
