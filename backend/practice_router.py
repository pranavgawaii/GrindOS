...
{{
  ...
  "solutionCode": "Write the final optimal code in {language}. Use natural, human-readable variable names. DO NOT include ANY comments or docstrings. No '#' comments, no inline comments. ONLY the raw code. {env_instruction}",
